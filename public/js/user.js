        ...
        self.periods.forEach(function(period) {
            ...
            if (period.is_current(remoteSecs)) {
                ...
                if (self.periods[0]==period){
                    if (period.is_lunch)
                        periodNames.push("<div class='current first lunch'>" + period.name + "<div>" + lunch_wave + "</div>" + "<div class='period-time-info'>" + (period.startTime().split(':')[0] < 13 ? period.startTime() : period.startTime().split(':')[0]-12+":"+period.startTime().split(':')[1])+ " - " +(period.endTime().split(':')[0] < 13 ? period.endTime() : period.endTime().split(':')[0]-12+":"+period.endTime().split(':')[1]) + "<div class='period-title'>" + classNames[parseInt(period.name)] + "</div>"  + "</div>" + "</div>");
                    else
                        periodNames.push("<div class='current first'>" + period.name + "<div class='period-time-info'>" + (period.startTime().split(':')[0] < 13 ? period.startTime() : period.startTime().split(':')[0]-12+":"+period.startTime().split(':')[1])+ " - " +(period.endTime().split(':')[0] < 13 ? period.endTime() : period.endTime().split(':')[0]-12+":"+period.endTime().split(':')[1]) + "<div class='period-title'>" + classNames[parseInt(period.name)] + "</div>"  + "</div>" + "</div>");
                }
                else{
                    if (period.is_lunch)
                        periodNames.push("<div class='current lunch'>" + period.name + "<div class='sub'>" + lunch_wave + "</div>" + "<div class='period-time-info lunch-info'>" + (period.startTime().split(':')[0] < 13 ? period.startTime() : period.startTime().split(':')[0]-12+":"+period.startTime().split(':')[1])+ " - " +(period.endTime().split(':')[0] < 13 ? period.endTime() : period.endTime().split(':')[0]-12+":"+period.endTime().split(':')[1])+ "<div class='period-title'>" + classNames[parseInt(period.name)] + "</div>"  + "</div>" + "</div>");
                    else
                        periodNames.push("<div class='current'>" + period.name + "<div class='period-time-info'>" + (period.startTime().split(':')[0] < 13 ? period.startTime() : period.startTime().split(':')[0]-12+":"+period.startTime().split(':')[1])+ " - " +(period.endTime().split(':')[0] < 13 ? period.endTime() : period.endTime().split(':')[0]-12+":"+period.endTime().split(':')[1])+ "<div class='period-title'>" + classNames[parseInt(period.name)] + "</div>"  + "</div>" + "</div>");
                }
            } else if ($('.panel-body').has('.tv-schedule').length) {
                if (period.is_lunch)
                    periodNames.push("<div class='lunch'>" + period.name + "<div class='sub'>L</div>" + "<div class='period-time-info responsive-info'>" + (period.startTime().split(':')[0] < 13 ? period.startTime() : period.startTime().split(':')[0]-12+":"+period.startTime().split(':')[1])+ " - " +(period.endTime().split(':')[0] < 13 ? period.endTime() : period.endTime().split(':')[0]-12+":"+period.endTime().split(':')[1])+ "<div class='period-title'>" + classNames[parseInt(period.name)] + "</div>"  + "</div>" + "</div>");
                else
                    periodNames.push("<div>" + period.name + "<div class='period-time-info responsive-info'>" + (period.startTime().split(':')[0] < 13 ? period.startTime() : period.startTime().split(':')[0]-12+":"+period.startTime().split(':')[1])+ " - " +(period.endTime().split(':')[0] < 13 ? period.endTime() : period.endTime().split(':')[0]-12+":"+period.endTime().split(':')[1]) + "<div class='period-title'>" + classNames[parseInt(period.name)] + "</div>"  + "</div>" + "</div>");
            }
            else{
                if (period.is_lunch)
